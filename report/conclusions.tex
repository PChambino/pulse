...
% TODO contribute back to the OpenCV for Android
% Nevertheless, because the OpenCV library was in its early stage on the Android platform, some features dealing with the Android UI were still unavailable and had to be implemented.
