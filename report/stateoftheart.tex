...
\section{Related Work} \label{sec:sota:relatedwork}
...
\subsection{\ica} \label{sec:sota:ica}
...
\section{\evm} \label{sec:sota:evm}
...
\subsection{Emphasize color variations for human pulse} \label{sec:sota:evm:color}
...
\section{Technologies} \label{sec:sota:technologies}
