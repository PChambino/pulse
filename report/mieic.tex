...
%\usepackage[mieic,juri,onpaper]{feupteses}
...
%% Include tabular multirow package
\usepackage{multirow}
...
\thesisdate{July 18, 2013}

%%Uncomment next line for copyright text if used
%\copyrightnotice{Name of the Author, 2008}

\supervisor{Supervisor}{Prof. Luís Teixeira}
...
\committeemember{Chair}{Prof. Jorge Alves da Silva}
\committeemember{External Examiner}{Prof. João Miguel da Costa Magalhães}
\committeemember{Supervisor}{Prof. Luís Filipe Pinto de Almeida Teixeira}
\signature
